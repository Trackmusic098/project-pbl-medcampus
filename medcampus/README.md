<p align="center"><kbd><img src="https://raw.githubusercontent.com/bubblevy/bubbleclinic/main/public/assets/img/demo.png" width="100%" alt="Medcampus Demo"></kbd></p>

## About Medcampus

<b>medcampus</b> is an application used for the process of taking queue numbers at clinics. This kind of application helps in managing patient queues at clinics or health care centers. Here are some of the features that BubbleClinic may have:
...
```sh
git clone https://github.com/bubbleJosejoshua/medcampus.git
```
